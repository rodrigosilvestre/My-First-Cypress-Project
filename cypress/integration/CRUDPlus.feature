...
Feature: CRUD Plus
   ...
   #Regra: É necessário que o item adicionado tenha um nome
   #Regra: É necessário que o item adicionado tenha um preço
   @Testes-Adicionar
   ...
   #Regra: Deve ser possivel adicionar itens na tabela
   #Regra: Deve ser possivel excluir itens na tabela
   #Regra: Deve ser possivel excluir itens selecionados na tabela
   #Regra: É necessário que o item adicionado tenha um nome
   #Regra: É necessário que o item adicionado tenha um preço
   ...
   Examples:
    ...
    #Regra: Deve ser possivel que o usuario possa usar a ferramenta (filtro) do site
   ...
   #Regra: Deve ser possivel que o usuario possa usar a ferramenta (Show Warning) do site
   #Regra: Deve ser possivel que o usuario possa usar a ferramenta (Show Info) do site
   @Testes-Consultar
   ...
   #Regra: Deve ser possivel editar os itens da tabela
   ...
   #Regra: Deve ser possivel selecionar todos os itens da tabela
   #Regra: Deve ser possivel excluir todos os itens da tabela
   #Regra: O índice de itens passiveis de exclusão deve começar a partir de 1
   @Testes-Deletar
   ...
   #Regra: Deve ser possivel adicionar itens na tabela
   #Regra: Deve ser possivel excluir itens que estão sendo criados
   #Regra: Tem que haver pelo menos um item sendo criado
   #Regra: Tem que haver pelo menos um item que está sendo e foi selecionado
   ...
   #Regra: Deve ser possivel que o usuario possa alterar a região do site
   @Testes-Idioma
